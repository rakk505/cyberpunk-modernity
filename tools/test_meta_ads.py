#!/usr/bin/env python3
"""Focused regression tests for the procedural Meta advertising campaigns."""
...
class MetaAdGeneratorTests(unittest.TestCase):
    ...
    def test_catalog_manifest_and_audio_are_consistent(self) -> None:
        ...
        self.assertEqual(2_064, process_ads.MAX_TOTAL_FRAMES)
        self.assertEqual(130, process_ads.MAX_TOTAL_SHEETS)
        self.assertEqual(2_064, manifest["total_frames"])
        self.assertEqual(130, manifest["total_sheets"])
    ...
    def test_provenance_excludes_historical_third_party_media(self) -> None:
        ...
        self.assertIn("No historical", ads_doc)
